(function(t) {
    ...
    t.extend(J.prototype, {
        ...
        getSegClasses: function(t, e, i) {
            if (typeof t.event.style == 'undefined') {
                eventstyle = "";
            }
            else {
                eventstyle = t.event.style
            }
            //debugger;
            var n = t.event
              , r = ["fc-event", t.isStart ? "fc-start" : "fc-not-start", t.isEnd ? "fc-end" : "fc-not-end"].concat(n.className, n.source ? n.source.className : []).concat(" " + eventstyle);
